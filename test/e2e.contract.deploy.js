...
describe('contract.deploy [ @E2E ]', function() {
    ...
    describe('http', function() {
        before(async function(){
            ...
            reverts = new web3.tpc.Contract(Reverts.abi, revertsOptions);
            noBytecode = new web3.tpc.Contract(Basic.abi, noBytecodeOptions);
        })
                ...
                await basic
                    ...
                    .on('confirmation', async (number, receipt, latestBlockHash) => {
                        ...
                        if (number === 1) { // Confirmation numbers are zero indexed
                            var endBlock = await web3.tpc.getBlock('latest');
