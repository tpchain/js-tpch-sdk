...
describe('lib/web3/batch', function () {
    describe('execute', function () {
        it('should execute batch request', function (done) {
            ...
            batch.add(web3.tpc.getBalance.request('0x0000000000000000000000000000000000000000', 'latest', callback));
            batch.add(web3.tpc.getBalance.request('0x0000000000000000000000000000000000000005', 'latest', callback2));
            batch.execute();
        });
        ...
        it('should execute batch request for async properties', function (done) {
            ...
            var batch = new web3.BatchRequest();
            batch.add(web3.tpc.getAccounts.request(callback));
        ...
        it('should execute batch request with contract', function (done) {
            ...
            var batch = new web3.BatchRequest();
            batch.add(web3.tpc.getBalance.request('0x0000000000000000000000000000000000000022', 'latest', callback));
            batch.add(new web3.tpc.Contract(abi, address).methods.balance(address).call.request(callback2));
            batch.add(new web3.tpc.Contract(abi, address).methods.balance(address).call.request({from: '0x1000000000000000000000000000000000000002'}, callback2));
            batch.add(new web3.tpc.Contract(abi, address).methods.balance(address).call.request({from: '0x1000000000000000000000000000000000000003'}, 10, callback2));
            batch.add(new web3.tpc.Contract(abi, address).methods.balance(address).call.request(10, callback3));
        ...
        it('should execute batch requests and receive errors', function (done) {
            ...
            var batch = new web3.BatchRequest();
            batch.add(web3.tpc.getBalance.request('0x0000000000000000000000000000000000000000', 'latest', callback));
            batch.add(new web3.tpc.Contract(abi, address).methods.balance(address).call.request({from: '0x0000000000000000000000000000000000000000'}, 10, callback2));
        ...
        it('should propagate output formatter error to callback', function(done) {
            ...
            batch.add(new web3.tpc.Contract(abi, address)
                .methods.symbol()
