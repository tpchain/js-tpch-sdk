...
function runTests(){
    tests.forEach(function (test, i) {
        it("encrypt tpc.account, and compare to ethers wallet", async () => {
        ...
        it("encrypt tpc.account, and decrypt with ethers wallet", async () => {
            var ethAccounts = new Accounts();
        ...
        it("encrypt ethers wallet, and decrypt with tpc.account", async () => {
            var ethAccounts = new Accounts();
        ...
        it("decrypt static signature using ethers wallet and tpc.account and compare", async () => {
            var ethAccounts = new Accounts();
