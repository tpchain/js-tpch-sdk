...
The ``web3.tpc.Iban`` function converts Ethereum addresses from and to IBAN and BBAN.
...
.. code-block:: javascript
    ...
    var iban = new web3.tpc.Iban("XE7338O073KYGTWWZN0F2WZ0R8PX5ZPPZS");
    > Iban { _iban: 'XE7338O073KYGTWWZN0F2WZ0R8PX5ZPPZS' }
...
.. code-block:: javascript
    ...
    web3.tpc.Iban.toAddress(ibanAddress)
...
.. code-block:: javascript
    ...
    web3.tpc.Iban.toAddress("XE7338O073KYGTWWZN0F2WZ0R8PX5ZPPZS");
...
.. code-block:: javascript
    ...
    web3.tpc.Iban.toIban("0x00c5496aEe77C1bA1f0854206A26DdA82a81D6D8");
...
.. code-block:: javascript
    ...
    web3.tpc.Iban.fromAddress(address)
...
.. code-block:: javascript
    ...
    web3.tpc.Iban.fromAddress("0x00c5496aEe77C1bA1f0854206A26DdA82a81D6D8");
    > Iban {_iban: "XE7338O073KYGTWWZN0F2WZ0R8PX5ZPPZS"}
...
.. code-block:: javascript
    ...
    web3.tpc.Iban.fromBban(bbanAddress)
...
.. code-block:: javascript
    ...
    web3.tpc.Iban.fromBban('ETHXREGGAVOFYORK');
    > Iban {_iban: "XE7338O073KYGTWWZN0F2WZ0R8PX5ZPPZS"}
...
.. code-block:: javascript
    ...
    web3.tpc.Iban.createIndirect(options)
...
.. code-block:: javascript
    ...
    web3.tpc.Iban.isValid(ibanAddress)
...
.. code-block:: javascript
    ...
    web3.tpc.Iban.isValid("XE81ETHXREGGAVOFYORK");
    > true

    web3.tpc.Iban.isValid("XE82ETHXREGGAVOFYORK");
...
.. code-block:: javascript
    ...
    web3.tpc.Iban.prototype.isValid()
...
.. code-block:: javascript
    ...
    var iban = new web3.tpc.Iban("XE81ETHXREGGAVOFYORK");
    iban.isValid();
    > true
...
.. code-block:: javascript
    ...
    web3.tpc.Iban.prototype.isDirect()
...
.. code-block:: javascript
    ...
    web3.tpc.Iban.prototype.isIndirect()
...
.. code-block:: javascript
    ...
    web3.tpc.Iban.prototype.checksum()
...
.. code-block:: javascript
    ...
    web3.tpc.Iban.prototype.institution()
...
.. code-block:: javascript
    ...
    web3.tpc.Iban.prototype.client()
...
.. code-block:: javascript
    ...
    web3.tpc.Iban.prototype.toString()
