...
The ``web3.tpc.accounts`` contains functions to generate Ethereum accounts and sign transactions and data.
...
.. code-block:: javascript
    ...
    // Passing in the tpc or web3 package is necessary to allow retrieving chainId, gasPrice and nonce automatically
...
.. code-block:: javascript
    ...
    web3.tpc.accounts.create([entropy]);
...
``Object`` - The account object with the following structure:
    ...
    - ``signTransaction(tx [, callback])`` - ``Function``: The function to sign transactions. See :ref:`web3.tpc.accounts.signTransaction() <eth-accounts-signtransaction>` for more.
    - ``sign(data)`` - ``Function``: The function to sign transactions. See :ref:`web3.tpc.accounts.sign() <eth-accounts-sign>` for more.
...
.. code-block:: javascript
    ...
    web3.tpc.accounts.create('2435@#@#@±±±±!!!!678543213456764321§34567543213456785432134567');
    > {
    ...
    web3.tpc.accounts.create(web3.utils.randomHex(32));
    > {
...
.. code-block:: javascript
    ...
    web3.tpc.accounts.privateKeyToAccount(privateKey [, ignoreLength ]);
...
.. code-block:: javascript
    ...
    web3.tpc.accounts.privateKeyToAccount('0x348ce564d427a3311b6536bbcff9390d69395b06ed6c486954e971d960fe8709');
    > {
        address: '0xb8CE9ab6943e0eCED004cDe8e3bBed6568B2Fa01',
        privateKey: '0x348ce564d427a3311b6536bbcff9390d69395b06ed6c486954e971d960fe8709',
        signTransaction: function(tx){...},
...
.. code-block:: javascript
    ...
    web3.tpc.accounts.signTransaction(tx, privateKey [, callback]);
...
1. ``tx`` - ``Object``: The transaction object as follows:
    - ``nonce`` - ``String``: (optional) The nonce to use when signing this transaction. Default will use :ref:`web3.tpc.getTransactionCount() <eth-gettransactioncount>`.
    - ``chainId`` - ``String``: (optional) The chain id to use when signing this transaction. Default will use :ref:`web3.tpc.net.getId() <net-getid>`.
    - ``to`` - ``String``: (optional) The recevier of the transaction, can be empty when deploying a contract.
    - ``data`` - ``String``: (optional) The call data of the transaction, can be empty for simple value transfers.
    - ``value`` - ``String``: (optional) The value of the transaction in wei.
    - ``gasPrice`` - ``String``: (optional) The gas price set by this transaction, if empty, it will use :ref:`web3.tpc.getGasPrice() <eth-gasprice>`
...
``Promise`` returning ``Object``: The signed data RLP encoded transaction, or if ``returnSignature`` is ``true`` the signature values as follows:
    ...
    - ``rawTransaction`` - ``String``: The RLP encoded transaction, ready to be send using :ref:`web3.tpc.sendSignedTransaction <eth-sendsignedtransaction>`.
...
.. code-block:: javascript
    ...
    web3.tpc.accounts.signTransaction({
...
.. code-block:: javascript
    ...
    web3.tpc.accounts.recoverTransaction(rawTransaction);
...
.. code-block:: javascript
    ...
    web3.tpc.accounts.recoverTransaction('0xf86180808401ef364594f0109fc8df283027b6285cc889f5aa624eac1f5580801ca031573280d608f75137e33fc14655f097867d691d5c4c44ebe5ae186070ac3d5ea0524410802cdc025034daefcdfa08e7d2ee3f0b9d9ae184b2001fe0aff07603d9');
...
.. code-block:: javascript
    ...
    web3.tpc.accounts.hashMessage(message);

Hashes the given message to be passed :ref:`web3.tpc.accounts.recover() <accounts-recover>` function. The data  will be UTF-8 HEX decoded and enveloped as follows: ``"\x19Ethereum Signed Message:\n" + message.length + message`` and hashed using keccak256.
...
.. code-block:: javascript
    ...
    web3.tpc.accounts.hashMessage("Hello World")
    > "0xa1de988600a42c4b4ab089b619297c17d53cffae5d5120d82d8a92d0bb3b78f2"

    // the below results in the same hash
    web3.tpc.accounts.hashMessage(web3.utils.utf8ToHex("Hello World"))
    > "0xa1de988600a42c4b4ab089b619297c17d53cffae5d5120d82d8a92d0bb3b78f2"
...
.. code-block:: javascript
    ...
    web3.tpc.accounts.sign(data, privateKey);
...
.. code-block:: javascript
    ...
    web3.tpc.accounts.sign('Some data', '0x4c0883a69102937d6231471b5dbb6204fe5129617082792ae468d01a3f362318');
    > {
        message: 'Some data',
...
.. code-block:: javascript
    ...
    web3.tpc.accounts.recover(signatureObject);
    web3.tpc.accounts.recover(message, signature [, preFixed]);
    web3.tpc.accounts.recover(message, v, r, s [, preFixed]);
...
.. code-block:: javascript
    ...
    // message, signature
    web3.tpc.accounts.recover('Some data', '0xb91467e570a6466aa9e9876cbcd013baba02900b8979d43fe208a4a4f339f5fd6007e74cd82e037b800186422fc2da167c747ef045e5d18a5f5d4300f8e1a0291c');
    > "0x2c7536E3605D9C16a7a3D7b1898e529396a65c23"

    // message, v, r, s
    web3.tpc.accounts.recover('Some data', '0x1c', '0xb91467e570a6466aa9e9876cbcd013baba02900b8979d43fe208a4a4f339f5fd', '0x6007e74cd82e037b800186422fc2da167c747ef045e5d18a5f5d4300f8e1a029');
    > "0x2c7536E3605D9C16a7a3D7b1898e529396a65c23"
...
.. code-block:: javascript
    ...
    web3.tpc.accounts.encrypt(privateKey, password);
...
.. code-block:: javascript
    ...
    web3.tpc.accounts.encrypt('0x4c0883a69102937d6231471b5dbb6204fe5129617082792ae468d01a3f362318', 'test!')
    > {
        version: 3,
...
.. code-block:: javascript
    ...
    web3.tpc.accounts.decrypt(keystoreJsonV3, password);
...
.. code-block:: javascript
    ...
    web3.tpc.accounts.wallet;

Contains an in memory wallet with multiple accounts. These accounts can be used when using :ref:`web3.tpc.sendTransaction() <eth-sendtransaction>`.
...
.. code-block:: javascript
    ...
    web3.tpc.accounts.wallet.create(numberOfAccounts [, entropy]);
...
.. code-block:: javascript
    ...
    web3.tpc.accounts.wallet.create(2, '54674321§3456764321§345674321§3453647544±±±§±±±!!!43534534534534');
    > Wallet {
        0: {...},
        "0xF0109fC8DF283027b6285cc889F5aA624EaC1F55": {...},
        "0xf0109fc8df283027b6285cc889f5aa624eac1f55": {...},
...
.. code-block:: javascript
    ...
    web3.tpc.accounts.wallet.add(account);
...
1. ``account`` - ``String|Object``: A private key or account object created with :ref:`web3.tpc.accounts.create() <accounts-create>`.
...
.. code-block:: javascript
    ...
    web3.tpc.accounts.wallet.add('0x4c0883a69102937d6231471b5dbb6204fe5129617082792ae468d01a3f362318');
    > {
        index: 0,
        address: '0x2c7536E3605D9C16a7a3D7b1898e529396a65c23',
        privateKey: '0x4c0883a69102937d6231471b5dbb6204fe5129617082792ae468d01a3f362318',
...
.. code-block:: javascript
    ...
    web3.tpc.accounts.wallet.remove(account);
...
.. code-block:: javascript
    ...
    web3.tpc.accounts.wallet.remove('0xF0109fC8DF283027b6285cc889F5aA624EaC1F55');
    > true

    web3.tpc.accounts.wallet.remove(3);
    > false
...
.. code-block:: javascript
    ...
    web3.tpc.accounts.wallet.clear();
...
.. code-block:: javascript
    ...
    web3.tpc.accounts.wallet.encrypt(password);
...
.. code-block:: javascript
    ...
    web3.tpc.accounts.wallet.encrypt('test');
    > [ { version: 3,
...
.. code-block:: javascript
    ...
    web3.tpc.accounts.wallet.decrypt(keystoreArray, password);
...
.. code-block:: javascript
    ...
    web3.tpc.accounts.wallet.decrypt([
      { version: 3,
...
.. code-block:: javascript
    ...
    web3.tpc.accounts.wallet.save(password [, keyName]);
...
.. code-block:: javascript
    ...
    web3.tpc.accounts.wallet.save('test#!$');
    > true
...
.. code-block:: javascript
    ...
    web3.tpc.accounts.wallet.load(password [, keyName]);
...
.. code-block:: javascript
    ...
    web3.tpc.accounts.wallet.load('test#!$', 'myWalletKey');
    > Wallet {
        0: {...},
        1: {...},
        "0xF0109fC8DF283027b6285cc889F5aA624EaC1F55": {...},
