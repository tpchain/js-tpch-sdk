...
.. code-block:: javascript
    ...
    web3.tpc.personal.newAccount(password, [callback])
...
.. code-block:: javascript
    ...
    web3.tpc.personal.newAccount('!@superpassword')
    .then(console.log);
...
.. code-block:: javascript
    ...
    web3.tpc.personal.sign(dataToSign, address, password [, callback])
...
using :ref:`web3.tpc.personal.ecRecover <eth-personal-ecRecover>`. See example below.
...
.. code-block:: javascript
    ...
    web3.tpc.personal.sign("Hello world", "0x11f4d0A3c12e86B4b5F39B213F7E19D048276DAe", "test password!")
    .then(console.log);
    > "0x30755ed65396facf86c53e6217c52b4daebe72aa4941d89635409de4c9c7f9466d4e9aaec7977f05e923889b33c0d0dd27d7226b6e6f56ce737465c5cfd04be400"

    // the below is the same
    web3.tpc.personal.sign(web3.utils.utf8ToHex("Hello world"), "0x11f4d0A3c12e86B4b5F39B213F7E19D048276DAe", "test password!")
    .then(console.log);
    > "0x30755ed65396facf86c53e6217c52b4daebe72aa4941d89635409de4c9c7f9466d4e9aaec7977f05e923889b33c0d0dd27d7226b6e6f56ce737465c5cfd04be400"

    // recover the signing account address using original message and signed message
    web3.tpc.personal.ecRecover("Hello world", "0x30755ed65396...etc...")
    .then(console.log);
...
.. code-block:: javascript
    ...
    web3.tpc.personal.ecRecover(dataThatWasSigned, signature [, callback])
...
.. code-block:: javascript
    ...
    web3.tpc.personal.ecRecover("Hello world", "0x30755ed65396facf86c53e6217c52b4daebe72aa4941d89635409de4c9c7f9466d4e9aaec7977f05e923889b33c0d0dd27d7226b6e6f56ce737465c5cfd04be400").then(console.log);
    > "0x11f4d0A3c12e86B4b5F39B213F7E19D048276DAe"
...
.. code-block:: javascript
    ...
    web3.tpc.personal.signTransaction(transaction, password [, callback])
...
1. ``Object`` - The transaction data to sign :ref:`web3.tpc.sendTransaction() <eth-sendtransaction>` for more.
...
.. code-block:: javascript
    ...
    web3.tpc.personal.sendTransaction(transactionOptions, password [, callback])
...
.. code-block:: javascript
    ...
    web3.tpc.personal.unlockAccount(address, password, unlockDuraction [, callback])
...
.. code-block:: javascript
    ...
    web3.tpc.personal.unlockAccount("0x11f4d0A3c12e86B4b5F39B213F7E19D048276DAe", "test password!", 600)
...
.. code-block:: javascript
    ...
    web3.tpc.personal.lockAccount(address [, callback])
...
.. code-block:: javascript
    ...
    web3.tpc.personal.lockAccount("0x11f4d0A3c12e86B4b5F39B213F7E19D048276DAe")
...
.. code-block:: javascript
    ...
    web3.tpc.personal.getAccounts([callback])

Returns a list of accounts the node controls by using the provider and calling
the RPC method ``personal_listAccounts``. Using :ref:`web3.tpc.accounts.create() <accounts-create>`
will not add accounts into this list. For that use
:ref:`web3.tpc.personal.newAccount() <personal-newaccount>`.

The results are the same as :ref:`web3.tpc.getAccounts() <eth-getaccounts>` except that calls the RPC method ``eth_accounts``.
...
.. code-block:: javascript
    ...
    web3.tpc.personal.importRawKey(privateKey, password)
...
.. code-block:: javascript
    ...
    web3.tpc.personal.importRawKey("cd3376bb711cb332ee3fb2ca04c6a8b9f70c316fcdf7a1f44ef4c7999483295e", "password1234")
    .then(console.log);
