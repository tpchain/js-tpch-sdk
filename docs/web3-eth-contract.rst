...
The ``web3.tpc.Contract`` object makes it easy to interact with smart contracts on the ethereum blockchain.
...
.. code-block:: javascript
    ...
    new web3.tpc.Contract(jsonInterface[, address][, options])
...
.. code-block:: javascript
    ...
    var myContract = new web3.tpc.Contract([...], '0xde0B295669a9FD93d5F28D9Ec85E40f4cb697BAe', {
...
.. code-block:: javascript
    ...
    web3.tpc.Contract.defaultAccount
...
.. code-block:: javascript
    ...
    web3.tpc.Contract.defaultBlock
...
.. code-block:: javascript
    ...
    web3.tpc.Contract.transcationBlockTimeout
...
.. code-block:: javascript
    ...
    web3.tpc.Contract.transactionConfirmationBlocks
...
.. code-block:: javascript
    ...
    web3.tpc.Contract.transactionPollingTimeout
...
.. code-block:: javascript
    ...
    web3.tpc.Contract.handleRevert
...
.. code-block:: javascript
    ...
    var contract1 = new tpc.Contract(abi, address, {gasPrice: '12345678', from: fromAddress});
...
.. code-block:: javascript
    ...
    // web3.js
    var MyContract = new web3.tpc.Contract(abi, address);
