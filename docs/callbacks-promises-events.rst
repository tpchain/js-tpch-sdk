...
To cope with requirement we return a "promiEvent" for functions like ``web3.tpc.sendTransaction`` or contract methods.
...
.. code-block:: javascript
    ...
    web3.tpc.sendTransaction({from: '0x123...', data: '0x432...'})
