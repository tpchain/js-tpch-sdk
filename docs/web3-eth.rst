...
.. code-block:: javascript
    ...
    var tpc = new Eth(Eth.givenProvider || 'ws://some.local-or-remote.node:8546');
...
.. code-block:: javascript
    ...
    web3.tpc.getAccounts(console.log);
...
For ``web3.tpc.subscribe`` see the :ref:`Subscribe reference documentation <eth-subscribe>`.
...
For ``web3.tpc.Contract`` see the :ref:`Contract reference documentation <eth-contract>`.
...
For ``web3.tpc.Iban`` see the :ref:`Iban reference documentation <eth-iban>`.
...
For ``web3.tpc.personal`` see the :ref:`personal reference documentation <eth-personal>`.
...
For ``web3.tpc.accounts`` see the :ref:`accounts reference documentation <eth-accounts>`.
...
For ``web3.tpc.ens`` see the :ref:`ENS reference documentation <eth-ens>`.
...
For ``web3.tpc.abi`` see the :ref:`ABI reference documentation <eth-abi>`.
...
For ``web3.tpc.net`` see the :ref:`net reference documentation <eth-net>`.
...
.. code-block:: javascript
    ...
    web3.tpc.defaultAccount

This default address is used as the default ``"from"`` property, if no ``"from"`` property is specified in for the following methods:

- :ref:`web3.tpc.sendTransaction() <eth-sendtransaction>`
- :ref:`web3.tpc.call() <eth-call>`
- :ref:`new web3.tpc.Contract() -> myContract.methods.myMethod().call() <eth-contract-call>`
- :ref:`new web3.tpc.Contract() -> myContract.methods.myMethod().send() <eth-contract-send>`
...
.. code-block:: javascript
    ...
    web3.tpc.defaultAccount = '0x11f4d0A3c12e86B4b5F39B213F7E19D048276DAe';
...
.. code-block:: javascript
    ...
    web3.tpc.defaultBlock

The default block is used for certain methods. You can override it by passing in the defaultBlock as last parameter.
The default value is ``"latest"``.

- :ref:`web3.tpc.getBalance() <eth-getbalance>`
- :ref:`web3.tpc.getCode() <eth-getcode>`
- :ref:`web3.tpc.getTransactionCount() <eth-gettransactioncount>`
- :ref:`web3.tpc.getStorageAt() <eth-getstorageat>`
- :ref:`web3.tpc.call() <eth-call>`
- :ref:`new web3.tpc.Contract() -> myContract.methods.myMethod().call() <eth-contract-call>`
...
.. code-block:: javascript
    ...
    // set the default block
    web3.tpc.defaultHardfork = 'istanbul';
...
.. code-block:: javascript
    ...
    web3.tpc.defaultCommon = {customChain: {name: 'custom-network', chainId: 1, networkId: 1}, baseChain: 'mainnet', hardfork: 'petersburg'};
...
.. code-block:: javascript
    ...
    web3.tpc.transactionBlockTimeout
...
.. code-block:: javascript
    ...
    web3.tpc.transactionBlockTimeout = 100;
...
.. code-block:: javascript
    ...
    web3.tpc.transactionConfirmationBlocks
...
.. code-block:: javascript
    ...
    web3.tpc.transactionConfirmationBlocks = 50;
...
.. code-block:: javascript
    ...
    web3.tpc.transactionPollingTimeout
...
.. code-block:: javascript
    ...
    web3.tpc.transactionPollingTimeout = 1000;
...
.. code-block:: javascript
    ...
    web3.tpc.maxListenersWarningThreshold
...
.. code-block:: javascript
    ...
    web3.tpc.maxListenersWarningThreshold = 200;
...
.. code-block:: javascript
    ...
    web3.tpc.getProtocolVersion([callback])
...
.. code-block:: javascript
    ...
    web3.tpc.getBlockNumber([callback])
...
.. code-block:: javascript
    ...
    web3.tpc.getBalance(address [, defaultBlock] [, callback])
...
2. ``Number|String|BN|BigNumber`` - (optional) If you pass this parameter it will not use the default block set with :ref:`web3.tpc.defaultBlock <eth-defaultblock>`. Pre-defined block numbers as ``"earliest"``, ``"latest"`` and ``"pending"`` can also be used.
...
.. code-block:: javascript
    ...
    web3.tpc.getBalance("0x407d73d8a49eeb85d32cf465507dd71d507100c1")
    .then(console.log);
    > "1000000000000"
...
.. code-block:: javascript
    ...
    web3.tpc.getStorageAt(address, position [, defaultBlock] [, callback])
...
3. ``Number|String|BN|BigNumber`` - (optional) If you pass this parameter it will not use the default block set with :ref:`web3.tpc.defaultBlock <eth-defaultblock>`. Pre-defined block numbers as ``"earliest"``, ``"latest"`` and ``"pending"`` can also be used.
...
.. code-block:: javascript
    ...
    web3.tpc.getStorageAt("0x407d73d8a49eeb85d32cf465507dd71d507100c1", 0)
    .then(console.log);
...
.. code-block:: javascript
    ...
    web3.tpc.getCode(address [, defaultBlock] [, callback])
...
.. code-block:: javascript
    ...
    web3.tpc.getCode("0xd5677cf67b5aa051bb40496e68ad359eb97cfbf8")
    .then(console.log);
...
.. code-block:: javascript
     ...
     web3.tpc.getBlock(blockHashOrBlockNumber [, returnTransactionObjects] [, callback])
...
.. code-block:: javascript
    ...
    web3.tpc.getBlockTransactionCount(blockHashOrBlockNumber [, callback])
...
.. code-block:: javascript
    ...
    web3.tpc.getBlockTransactionCount("0x407d73d8a49eeb85d32cf465507dd71d507100c1")
    .then(console.log);
    > 1
...
.. code-block:: javascript
    ...
    web3.tpc.getBlockUncleCount(blockHashOrBlockNumber [, callback])
...
.. code-block:: javascript
    ...
    web3.tpc.getBlockUncleCount("0x407d73d8a49eeb85d32cf465507dd71d507100c1")
    .then(console.log);
    > 1
...
.. code-block:: javascript
    ...
    web3.tpc.getUncle(blockHashOrBlockNumber, uncleIndex [, returnTransactionObjects] [, callback])
...
``Promise`` returns ``Object`` - the returned uncle. For a return value see :ref:`web3.tpc.getBlock() <eth-getblock>`.
...
.. code-block:: javascript
    ...
    web3.tpc.getUncle(500, 0)
    .then(console.log);
    > // see web3.tpc.getBlock
...
.. code-block:: javascript
    ...
    web3.tpc.getTransaction(transactionHash [, callback])
...
.. code-block:: javascript
    ...
    web3.tpc.getTransaction('0x9fc76417374aa880d4449a1f7f31ec597f00b1f6f3dd2d66f4c9c6c445836d8b§234')
    .then(console.log);
...
.. code-block:: javascript
    ...
    web3.tpc.getPendingTransactions([, callback])
...
.. code-block:: javascript
    ...
    web3.tpc.getPendingTransactions().then(console.log);
    >  [
        {
            hash: '0x9fc76417374aa880d4449a1f7f31ec597f00b1f6f3dd2d66f4c9c6c445836d8b',
            nonce: 2,
...
``Promise`` returns ``Object`` - A transaction object, see :ref:`web3.tpc.getTransaction <eth-gettransaction-return>`:
...
.. code-block:: javascript
    ...
    var transaction = web3.tpc.getTransactionFromBlock('0x4534534534', 2)
    .then(console.log);
    > // see web3.tpc.getTransaction
...
.. code-block:: javascript
    ...
    web3.tpc.getTransactionReceipt(hash [, callback])
...
.. code-block:: javascript
    ...
    var receipt = web3.tpc.getTransactionReceipt('0x9fc76417374aa880d4449a1f7f31ec597f00b1f6f3dd2d66f4c9c6c445836d8b')
    .then(console.log);
...
.. code-block:: javascript
    ...
    web3.tpc.getTransactionCount(address [, defaultBlock] [, callback])
...
.. code-block:: javascript
    ...
    web3.tpc.getTransactionCount("0x11f4d0A3c12e86B4b5F39B213F7E19D048276DAe")
    .then(console.log);
    > 1
...
.. code-block:: javascript
    ...
    web3.tpc.sendTransaction(transactionObject [, callback])
...
1. ``Object`` - The transaction object to send:
    - ``from`` - ``String|Number``: The address for the sending account. Uses the :ref:`web3.tpc.defaultAccount <eth-defaultaccount>` property, if not specified. Or an address or index of a local wallet in :ref:`web3.tpc.accounts.wallet <eth_accounts_wallet>`.
    ...
    - ``gasPrice`` - ``Number|String|BN|BigNumber``: (optional) The price of gas for this transaction in :ref:`wei <what-is-wei>`, defaults to :ref:`web3.tpc.gasPrice <eth-gasprice>`.
...
.. note:: The ``from`` property can also be an address or index from the :ref:`web3.tpc.accounts.wallet <eth_accounts_wallet>`. It will then sign locally using the private key of that account, and send the transaction via :ref:`web3.tpc.sendSignedTransaction() <eth-sendsignedtransaction>`. If the properties ``chain`` and ``hardfork`` or ``common`` are not set, Web3 will try to set appropriate values by querying the network for its chainId and networkId.
...
.. code-block:: javascript
    ...
    web3.tpc.sendSignedTransaction(signedTransactionData [, callback])

Sends an already signed transaction, generated for example using :ref:`web3.tpc.accounts.signTransaction <eth-accounts-signtransaction>`.
...
Please see the return values for :ref:`web3.tpc.sendTransaction <eth-sendtransaction-return>` for details.
...
.. code-block:: javascript
    ...
    web3.tpc.sendSignedTransaction('0x' + serializedTx.toString('hex'))
    .on('receipt', console.log);

    > // see tpc.getTransactionReceipt() for details
...
.. code-block:: javascript
    ...
    web3.tpc.sign(dataToSign, address [, callback])
...
2. ``String|Number`` - Address to sign data with. Can be an address or the index of a local wallet in :ref:`web3.tpc.accounts.wallet <eth-accounts-wallet>`.
3. ``Function`` - (optional) Optional callback, returns an error object as first parameter and the result as second.
...
.. code-block:: javascript
    ...
    web3.tpc.sign("Hello world", "0x11f4d0A3c12e86B4b5F39B213F7E19D048276DAe")
    .then(console.log);
    > "0x30755ed65396facf86c53e6217c52b4daebe72aa4941d89635409de4c9c7f9466d4e9aaec7977f05e923889b33c0d0dd27d7226b6e6f56ce737465c5cfd04be400"

    // the below is the same
    web3.tpc.sign(web3.utils.utf8ToHex("Hello world"), "0x11f4d0A3c12e86B4b5F39B213F7E19D048276DAe")
    .then(console.log);
    > "0x30755ed65396facf86c53e6217c52b4daebe72aa4941d89635409de4c9c7f9466d4e9aaec7977f05e923889b33c0d0dd27d7226b6e6f56ce737465c5cfd04be400"
...
.. code-block:: javascript
    ...
    web3.tpc.signTransaction(transactionObject, address [, callback])
...
1. ``Object`` - The transaction data to sign. See :ref:`web3.tpc.sendTransaction() <eth-sendtransaction>` for more.
...
``Promise`` returns ``Object`` - The RLP encoded transaction. The ``raw`` property can be used to send the transaction using :ref:`web3.tpc.sendSignedTransaction <eth-sendsignedtransaction>`.
...
.. code-block:: javascript
    ...
    web3.tpc.call(callObject [, defaultBlock] [, callback])
...
1. ``Object`` - A transaction object, see :ref:`web3.tpc.sendTransaction <eth-sendtransaction-return>`. For calls the ``from`` property is optional however it is highly recommended to explicitly set it or it may default to `address(0)` depending on your node or provider.
2. ``Number|String|BN|BigNumber`` - (optional) If you pass this parameter it will not use the default block set with :ref:`web3.tpc.defaultBlock <eth-defaultblock>`. Pre-defined block numbers as ``"earliest"``, ``"latest"`` and ``"pending"`` can also be used.
3. ``Function`` - (optional) Optional callback, returns an error object as first parameter and the result as second.
...
.. code-block:: javascript
    ...
    web3.tpc.estimateGas(callObject [, callback])
...
1. ``Object`` - A transaction object, see :ref:`web3.tpc.sendTransaction <eth-sendtransaction-return>` with the difference that for calls the ``from`` property is optional as well.
2. ``Function`` - (optional) Optional callback, returns an error object as first parameter and the result as second.
...
.. code-block:: javascript
    ...
    web3.tpc.getPastLogs(options [, callback])
...
.. code-block:: javascript
    ...
    web3.tpc.submitWork(nonce, powHash, digest, [callback])
...
.. code-block:: javascript
    ...
    web3.tpc.requestAccounts([callback])
...
.. code-block:: javascript
    ...
    web3.tpc.requestAccounts().then(console.log);
...
.. code-block:: javascript
    ...
    web3.tpc.getChainId().then(console.log);
    > 61
...
.. code-block:: javascript
    ...
    web3.tpc.getNodeInfo().then(console.log);
...
.. code-block:: javascript
    ...
    web3.tpc.getProof(address, storageKey, blockNumber, [callback])
...
2. ``Number[] | BigNumber[] | BN[] | String[]`` 32 Bytes: Array of storage-keys which should be proofed and included. See :ref:`web3.tpc.getStorageAt <eth-getStorageAt>`.
...
``Promise<Object>`` - A account object.
    ...
    - ``balance`` - ``String``: The balance of the account. See :ref:`web3.tpc.getBalance <eth-getBalance>`.
