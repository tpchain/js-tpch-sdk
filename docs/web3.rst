...
``Object``: A list of module constructors:
    - ``Eth`` - ``Constructor``: The Eth module for interacting with the Ethereum network (:ref:`web3.tpc <tpc>`).
    - ``Net`` - ``Constructor``: The Net module for interacting with network properties (:ref:`web3.tpc.net <eth-net>`).
    - ``Personal`` - ``Constructor``: The Personal module for interacting with the Ethereum accounts (:ref:`web3.tpc.personal <personal>`).
