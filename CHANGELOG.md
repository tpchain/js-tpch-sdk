...
- Add `tpc.getChainId` method (#3113)
...
- Fix TS types for tpc.subscribe syncing, newBlockHeaders, pendingTransactions (#3159)
...
- Fix user supplied callback not fired in tpc.accounts.signTransaction (#3283)
...
- Size property de-referencing crash when calling web3.tpc.clearSubscriptions (#3527)
